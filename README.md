...
Change directory into `/dnd` and run `sh ./bootstrap.sh`.  This part will take a while.
...
`git remote add upstream git@github.com:PendragonDevelopment/devsanddragons.git`
